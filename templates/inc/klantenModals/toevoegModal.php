        ...
        <div class="modal-content">
            <form action="add.php" method="post">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Voeg een klant toe</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="straatnaam">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="reden" class="form-control" cols="30" rows="10"></textarea>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-primary" name="toevoegen" value="Voeg toe">
                </div>
            </form>
        </div>
    </div>
